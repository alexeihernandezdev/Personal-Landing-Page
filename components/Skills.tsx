...
export function Skills() {
  ...
  return (
    <section id={sectionIds.skills} className="py-20 px-6 bg-gradient-to-b from-[#0F172A] via-[#0F172A] to-[#090E1B]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {skillGroups.map((skill, index) => {
            ...
            return (
              <motion.div 
                key={skill.icon}
                className="p-6 rounded-xl bg-[#1E293B]/80 backdrop-blur-sm border-2 border-[#334155] hover:border-[#06B6D4] hover:shadow-lg hover:shadow-[#06B6D4]/20 hover:bg-[#1E293B] transition-all"
